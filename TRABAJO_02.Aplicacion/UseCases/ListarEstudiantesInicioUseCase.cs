...
public class ListarEstudiantesInicioUseCase
{
    ...
    public ListarEstudiantesInicioUseCase(IRepositorioEstudiante rEstudiante, IRepositorioCurso rCurso, IRepositorioInscripcion rInscripcion)
    {
    ...
    public List<Inscripcion> Ejecutar()
    {
        ...
        foreach(Inscripcion inscripcion in inscripciones){
            ...
            if(fechaCursoFinalizacion!=null){
                if((fechaCursoFinalizacion.Value-DateTime.Now).Days>0){
